...
$currentstudent = getSetting('currentstudent');
...
<li>Student: <select id="filterstudent" onchange="{setStudent(document.getElementById('filterstudent'),'index.php');}"><?php echo get_students_selectoptions($currentstudent,'[Select...]'); ?></select></li>
<li>Current Language: <?php echo getLanguage($currentlang) ?></li>
<li>Current Student: <?php echo getStudent($currentstudent) ?></li>
